...
using SecretImage.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using SecretImage.AppFlyouts;
#endif
...
namespace SecretImage
{
    ...
    {
        private Guid APP_ID = new Guid("561f7341-6ba1-442d-9f96-b339253bd5ef");
        public const string APP_NAME = "SecretImage";
