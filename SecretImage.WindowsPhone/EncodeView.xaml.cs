...
{
    public sealed partial class EncodeView : PageBase
    {
        public EncodeView()
        {
        ...
        private async void SaveSecretImage_Click(object sender, RoutedEventArgs e)
        {
            ...
            response = null;
            this.TextInput.Text = "";
            this.ButtonImageSelect.IsEnabled = false;
            this.SecretImage.Source = null;
            this.GetSecretImage.IsEnabled = false;
            this.SaveSecretImage.IsEnabled = false;
        }
